...
public class AdminCadastroEstoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblNomeProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 150, -1));

        txtNomeProduto.setBackground(new java.awt.Color(235, 235, 235));
        txtNomeProduto.setBorder(null);
        getContentPane().add(txtNomeProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 450, 30));

        txtValidade.setBackground(new java.awt.Color(235, 235, 235));
        txtValidade.setBorder(null);
        getContentPane().add(txtValidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 180, 30));
